/**
 * Manifest prediction engine — learned logistic regression for relapse risk.
 *
 * Architecture:
 ...
 * Adds temporal derivatives, content signals, social graph dynamics,
...
export function computeRelapseRisk(features, model = null) {
  ...
  // --- Heuristic fallback when no learned model ---
  let base = 0;
