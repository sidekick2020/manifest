...
export const DEFAULT_PARAMS = {
  ...
  dynamicGravityRef: 500,     // reference member count where scale = 1.0 (no scaling)
  dynamicGravityMin: 0.15,    // minimum scale factor (very few members → very tight)
  dynamicGravityMax: 1.5,     // maximum scale factor (many members → spread out)
};
 ...
 *   10 members → ~0.15,  50 → ~0.32,  100 → ~0.45,  500 → 1.0,  2000 → ~1.5
 *
